...
for item in sequence_lines:
	sequence_lines2.append(re.sub("A*$", "", item))
print 'Here are Sequence_lines2:'
print '\n'
...
sequenceraw = "".join(sequence_lines2)
